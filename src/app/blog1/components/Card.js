        ...
        <div className="relative flex flex-col justify-between w-full h-full p-10 sm:p-16 text-white z-20">
          ...
          <div className="flex-grow mb-6">
            <div className="w-full md:w-4/5 lg:w-3/5">
              <h1 className="text-[32px] sm:text-[40px] md:text-[46px] lg:text-[50px] font-bold leading-tight font-poppins">
                {title}
              </h1>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6">
            {/* Date */}
            <p className="text-[18px] sm:text-[20px] font-medium">{date}</p>
