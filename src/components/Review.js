...
const ReviewCard = ({ featuredImage, title, content }) => (
  <div
    className="bg-stone-50 hover:scale-105 hover:shadow-2xl hover:mt-8 rounded-xl overflow-hidden  duration-300 flex flex-col"
    style={{
      width: "299px",
      height: "414px",
      top: "193px",
  ...
  >
    ...
    <div className="p-6 flex flex-col h-full   ">
      ...
      <div
        className="text-gray-600 text-sm leading-relaxed truncate   mb-4  flex-grow line-clamp-1 overflow-hidden"
...
// Main component
export default function App({ reviewdata, mortgagesdata }) {
  return (
